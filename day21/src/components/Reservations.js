...
const Reservations = () => {
    ...
    const handleAddReservations = (e) => {
       if(!reservNameInput) return;
        const newReservations = {name: reservNameInput, time: new Date().toUTCString() }
                ...
                <div className="reservation-container">
                    <div>
                        ...
                        <div className="reservation-cards-container">
                            {
                                reservations.map((resrve, index) => {
                                    return(
                                        <div key={index}>
                                             <ReservationCard name={resrve.name} time={resrve.time} index={index}/>
                                        </div>
                                    )
                                })
                            }
