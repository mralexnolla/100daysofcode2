const initialState = [
    {id: 0, contents: 'CodeTrain', visible: true, matched: true}, 
    {id: 1, contents: 'CodeTrain', visible: true, matched: true}, 
    {id: 2, contents: 'Javascript', visible: true, matched: true}, 
    {id: 3, contents: 'Javascript', visible: true, matched: true}, 
    {id: 4, contents: 'Reactjs', visible: true, matched: true}, 
    {id: 5, contents: 'Reactjs', visible: true, matched: true}, 
    {id: 6, contents: 'MongoDb', visible: true, matched: true}, 
    {id: 7, contents: 'MongoDb', visible: true, matched: true}, 
    {id: 8, contents: 'Nodejs', visible: true, matched: true}, 
    {id: 9, contents: 'Nodejs', visible: true, matched: true}, 
    {id: 10, contents: 'Express', visible: true, matched: true}, 
    {id: 11, contents: 'Express', visible: true, matched: true}, 
  ];
  ...
  //visible card objects selector
  export const selectVisibleIDs = state => state.board
  .filter(card => card.visible)
  .map(card => card.id)
  
  //matched card selector
